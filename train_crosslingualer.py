from utils import DATA_CONFIG, TRAINING_CONFIG, MODEL_CHECKPOINTS, MODEL_SAVE, MODEL_PATHS
from utils import load_target_test_data, load_huggingface_dataset
from crosslingual_ER import EmotionDataset
from sklearn.model_selection import train_test_split
from utils import check_lmmodel_exists, save_lmmodel, clear_gpu_memory, save_crosslingual_results
from crosslingual_ER import get_trainer
import os
...
def run(keys: dict, lm_name: str):
    ...
    try:
        val_dataset = load_target_test_data(DATA_CONFIG["TARGET_TEST_FILENAME"], cross_lingual=True)
